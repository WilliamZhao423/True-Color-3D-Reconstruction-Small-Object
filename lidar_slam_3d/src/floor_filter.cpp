                         ...
                         pcl::PointCloud<pcl::PointXYZRGB>::Ptr& floor_cloud)       // TODO @Yimin Zhao                 
{
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr clipped_cloud(new pcl::PointCloud<pcl::PointXYZRGB>); // TODO @Yimin Zhao

    //pcl::PassThrough<pcl::PointXYZI> pass_through_filter;
    pcl::PassThrough<pcl::PointXYZRGB> pass_through_filter; // TODO @Yimin Zhao
    ...
    pcl::NormalEstimation<pcl::PointXYZRGB, pcl::Normal> normal_estimator; // TODO @Yimin Zhao
    pcl::search::KdTree<pcl::PointXYZRGB>::Ptr tree(new pcl::search::KdTree<pcl::PointXYZRGB>); // TODO @Yimin Zhao
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr horizontal_cloud(new pcl::PointCloud<pcl::PointXYZRGB>); // TODO @Yimin Zhao
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr outliers_cloud(new pcl::PointCloud<pcl::PointXYZRGB>); // TODO @Yimin Zhao
    pcl::ExtractIndices<pcl::PointXYZRGB> extract;  // TODO @Yimin Zhao
